...
<div class="product-thumb-area">
	...
	?></a>
	<?php if ( BlogxerTheme::$options['wc_product_hover'] ): ?>
		<div class="product-info">
			<ul>
				<?php if ( function_exists( 'YITH_WCQV_Frontend' ) && BlogxerTheme::$options['wc_quickview_icon'] ): ?>
					<li><a href="" class="yith-wcqv-button" data-product_id="<?php echo esc_attr( $product->get_id() );?>"><i class="fa fa-search"></i></a></li>
				<?php endif; ?>
				<?php if ( class_exists( 'YITH_WCWL_Shortcode' ) && BlogxerTheme::$options['wc_wishlist_icon'] ) { ?>
					<?php
					$args = array(
