...
<?php if ( BlogxerTheme::$footer_area == 1 || BlogxerTheme::$footer_area == 'on' ){ ?>
		<div class="footer-top-area">
			<div class="container">
				<div class="row">
					<div class="col-md-2">
						<div class="footer-logo"><a class="dark-logo" href="<?php echo esc_url( home_url( '/' ) );?>"><img src="<?php echo esc_url( $blogxer_light_logo );?>" alt="<?php esc_attr( bloginfo( 'name' ) ) ;?>"></a></div>
					</div>
					<div class="col-md-7">
						<?php
							for ( $i = 1; $i <= $blogxer_footer_column; $i++ ) {
								echo '<div class="' . $blogxer_footer_class . '">';
								dynamic_sidebar( 'footer-style-3' );
								echo '</div>';
							}
						?>
					</div>
