...
$blogxer_has_entry_meta2  = ( BlogxerTheme::$options['blog_author_name'] || BlogxerTheme::$options['blog_comment_num'] || BlogxerTheme::$options['blog_cats'] ) ? true : false;
	...
	<div class="blog-box">
		...
		<div class="blog-img-holder">
			...
			<a href="<?php the_permalink(); ?>" class="img-opacity-hover"><?php if ( has_post_thumbnail() ) { ?>
				<?php the_post_thumbnail( 'blogxer-size3', ['class' => 'img-responsive'] ); ?>
					<?php } else {
		...
		<div class="blog-content-holder">
			...
			<ul>
				...
				<?php } ?>
				<?php if ( BlogxerTheme::$options['blog_date'] ) { ?>
				<li><?php if ( !has_post_thumbnail() && ( BlogxerTheme::$options['display_no_preview_image'] == 'off'  ) ) { ?>
