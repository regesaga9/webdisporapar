...
$i = 1;	
?>
<div class="post-grid-default post-grid-<?php echo esc_attr( $data['style'] ); ?> <?php echo esc_attr( $data['content_align'] ); ?> <?php if ( empty( $data['meta_icon_display'] ) || ($data['meta_icon_display'] == 'no') ) { ?>no-icon<?php } ?>">
	<?php
					...
					<div class="post-content-holder">
						<div class="rtin-content">
							<div class="text-wrapper">
								...
								<?php } ?>
								<h3 class="rtin-title"><a href="<?php the_permalink();?>"><?php echo esc_html( $title );?></a></h3><?php if ( ( $data['author_display']  == 'yes' ) || ( $data['date_display']  == 'yes' ) || ( $data['read_time_display']  == 'yes' ) || ( $data['view_display']  == 'yes' ) || ( $data['comment_display']  == 'yes' ) ) { ?>
								<div class="post-meta">
									<ul>
								...
								<?php } ?><?php if ( $data['content_display']  == 'yes' ) { ?><?php echo wp_kses_post( $excerpt ); ?><?php } ?><?php if ( $data['button_display']  == 'yes' ) { ?>
							...
							<?php
								if ( has_post_thumbnail() ){
									...
									if ( !empty( BlogxerTheme::$options['no_preview_image']['id'] ) ) {
										...
										echo '<img class="wp-post-image" src="' . BlogxerTheme_Helper::get_img( 'noimage_630X517.jpg' ) . '" alt="'.get_the_title().'">';
									}
								}
							?>
						</a>
					...
					<div class="post-content-holder">
						<div class="rtin-content">
							<div class="text-wrapper">
								...
								<?php if ( ( $data['author_display']  == 'yes' ) || ( $data['date_display']  == 'yes' ) || ( $data['read_time_display']  == 'yes' ) || ( $data['view_display']  == 'yes' ) || ( $data['comment_display']  == 'yes' ) ) { ?>
								<div class="post-meta">
									<ul>
										<?php if ( $data['author_display']  == 'yes' ) { ?>
										<li><i class="fa fa-user" aria-hidden="true"></i><?php the_author_posts_link(); ?></li>
					...
					<div class="post-content-holder">
						<div class="rtin-content">
							<div class="text-wrapper">
								...
								</div><?php } ?><?php if ( $data['content_display']  == 'yes' ) { ?><?php echo wp_kses_post( $excerpt );?><?php } ?>
								<?php if ( $data['button_display']  == 'yes' ) { ?>
								<div class="post-footer">									
									<?php if ( $data['button_display']  == 'yes' ) { ?>
										<a class="item-btn" href="<?php the_permalink(); ?>"><span><?php esc_html_e( 'READ MORE', 'blogxer-core' ); ?></span><?php if ( is_rtl() ) { ?><i class="fa fa-arrow-right" aria-hidden="true"></i><?php } else { ?><i class="fa fa-arrow-right" aria-hidden="true"></i><?php } ?></a>
					...
					<div class="post-content-holder">
						<div class="rtin-content">
							<div class="text-wrapper">
								...
								</div><?php } ?><?php if ( $data['content_display']  == 'yes' ) { ?><?php echo wp_kses_post( $excerpt );?><?php } ?><?php if ( $data['button_display']  == 'yes' ) { ?>
								<div class="post-footer">									
									<?php if ( $data['button_display']  == 'yes' ) { ?>
										<a class="item-btn" href="<?php the_permalink(); ?>"><span><?php esc_html_e( 'READ MORE', 'blogxer-core' ); ?></span><?php if ( is_rtl() ) { ?><i class="fa fa-arrow-right" aria-hidden="true"></i><?php } else { ?><i class="fa fa-arrow-right" aria-hidden="true"></i><?php } ?></a>
									<?php } ?>
