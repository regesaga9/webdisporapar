...
$thumb_size1 = 'blogxer-size11';
$thumb_size2 = 'blogxer-size12';
						...
						<?php
							if ( has_post_thumbnail() ){
								...
								if ( !empty( BlogxerTheme::$options['no_preview_image']['id'] ) ) {
									...
									echo '<img class="wp-post-image" src="' . BlogxerTheme_Helper::get_img( 'noimage_800X457.jpg' ) . '" alt="'.get_the_title().'">';
								}
							}
						?>
					</a>
						...
						<?php
							if ( has_post_thumbnail() ){
								...
								if ( !empty( BlogxerTheme::$options['no_preview_image']['id'] ) ) {
									...
									echo '<img class="wp-post-image" src="' . BlogxerTheme_Helper::get_img( 'noimage_400X476.jpg' ) . '" alt="'.get_the_title().'">';
								}
							}
						?>
					</a>
		...
		<div class="col-lg-8 col-md-8 col-sm-12 col-12">
			<div class="rtin-single-post">
				...
				<div class="rtin-content">
					...
					<?php } ?>
					<h3 class="rtin-title"><a href="<?php the_permalink();?>"><?php echo esc_html( $title );?></a></h3><?php if ( $data['content_display']  == 'yes' ) { ?><?php echo wp_kses_post( $content );?><?php } ?><?php if ( ( $data['button_display']  == 'yes' ) || ( $data['view_display']  == 'yes' ) || ( $data['comment_display']  == 'yes' ) ) { ?>
					<div class="post-footer">
						<?php if ( $data['button_display']  == 'yes' ) { ?>
							<a class="item-btn" href="<?php the_permalink(); ?>"><span><?php esc_html_e( 'READ MORE', 'blogxer-core' ); ?></span><?php if ( is_rtl() ) { ?><i class="fa fa-arrow-right" aria-hidden="true"></i><?php } else { ?><i class="fa fa-arrow-right" aria-hidden="true"></i><?php } ?></a>
						<?php } ?>
