...
class Post_List extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Post List', 'blogxer-core' );
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'style1' => esc_html__( 'List Style 1', 'blogxer-core' ),
					'style2' => esc_html__( 'List Style 2', 'blogxer-core' ),
					'style3' => esc_html__( 'List Style 3', 'blogxer-core' ),
				),
				'default' => 'style1',
			),			
			...
			array (
				...
				'selector' => '{{WRAPPER}} .post-list-default .rtin-single-post .rtin-content h3',
			),
			array (
				'mode'    => 'group',
				'type'    => Group_Control_Typography::get_type(),
				...
				'selector' => '{{WRAPPER}} .post-list-default.post-list-style2 .rtin-single-post .content-right .rtin-content h3',
			...
			array (
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-list-default .post-meta ul li i' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-list-default .post-footer ul li i' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-list-default .post-meta ul li' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-list-default .post-meta ul li a' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-list-default .post-footer ul li' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-list-default .post-footer ul li a' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-list-default .post-meta ul li a:hover' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-list-default .post-footer ul li a:hover' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-list-default .rtin-single-post .rtin-content h3 a' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-list-default .rtin-single-post .rtin-content h3 a:hover' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-list-default .rtin-single-post .rtin-content' => 'color: {{VALUE}}',
				),
			),			
