...
class Post_Grid extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Post Grid', 'blogxer-core' );
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'style1' => esc_html__( 'Grid Style 1', 'blogxer-core' ),
					'style2' => esc_html__( 'Grid Style 2', 'blogxer-core' ),
					'style3' => esc_html__( 'Grid Style 3', 'blogxer-core' ),
					'style4' => esc_html__( 'Grid Style 4', 'blogxer-core' ),
					'style5' => esc_html__( 'Grid Style 5', 'blogxer-core' ),
					'style6' => esc_html__( 'Grid Style 6', 'blogxer-core' ),
				),
				'default' => 'style1',
			),
			...
			array (
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'cat_num',
				'label'   => __( 'Single Category /<br> Multiple category Select', 'blogxer-core' ),
				'options' => array(
			...
			array(
				...
				'label'       => esc_html__( 'Pagination Display', 'blogxer-core' ),
			...
			array (
				...
				'selector' => '{{WRAPPER}} .post-grid-default .rtin-single-post .rtin-content h3',
			),
			array (
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-grid-default .rtin-single-post .post-meta ul li i' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-grid-default .post-footer ul li i' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-grid-default .rtin-single-post .post-meta ul li' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-grid-default .rtin-single-post .post-meta ul li a' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-grid-default .post-footer ul li' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-grid-default .post-footer ul li a' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-grid-default .rtin-single-post .post-meta ul li a:hover' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post-grid-default .post-footer ul li a:hover' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-grid-default .rtin-single-post .rtin-content h3 a' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-grid-default .rtin-single-post .rtin-content h3 a:hover' => 'color: {{VALUE}}',
				),
			),
			array (
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array( 
					'{{WRAPPER}} .post-grid-default .rtin-single-post .rtin-content' => 'color: {{VALUE}}',
				),
			),
